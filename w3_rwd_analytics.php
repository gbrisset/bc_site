...
<nav class="w3-sidenav w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidenav"><br>
  ...
  <a href="#" class="w3-padding"><i class="fa fa-cog fa-fw"></i>&nbsp;Technologies</a>
  <a href="#" class="w3-padding"><i class="fa fa-briefcase fa-fw"></i>&nbsp;Employment</a>
  <a href="#" class="w3-padding"><i class="fa fa-user fa-fw"></i>&nbsp;Personal profile</a>
  <a href="#" class="w3-padding"><i class="fa fa-envelope fa-fw"></i>&nbsp;Contact</a>
</nav>
